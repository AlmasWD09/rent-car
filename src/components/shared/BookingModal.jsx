...
const BookingModal = ({ closeModal }) => {
  ...
  return (
    ...
    >
      <div className="bg-white place-items-end  max-w-3xl w-full">
        <div className="flex items-center justify-between w-full bg-primary p-6">
          <h1 className="text-2xl font-semibold text-white"> Booking Form</h1>
